...
if ask_yes_no "Do you want to install Oh My Zsh plugins?"; then
  if ! $DRY_RUN; then
    ...
    git clone https://github.com/MichaelAquilina/zsh-you-should-use.git $ZSH_CUSTOM/plugins/you-should-use || log "Failed to install you-should-use"
    progress_bar 5
  else
  ...
  if ! $DRY_RUN; then
    {
      ...
      echo 'plugins=(git aws dirhistory docker docker-compose dotenv fzf golang nvm pep8 pip pylint you-should-use zsh_codex zsh-autosuggestions zsh-syntax-highlighting)'
